...
public class TC20_AIP_NL_292_FA_TVPVRBOX_COMPLETE extends AppiumSetup implements Constants{
	...
	public void TC01SBBNewlinePostCodeOnly() throws Exception {
		...
		WCCheck.GreatNews_CompleteOrder("PLUS TV",PackName);
		/*
		if(testcase.toUpperCase().contains("Completed"))
		{
