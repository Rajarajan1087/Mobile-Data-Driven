...
public class TC31_AIP_NL_293_TVStore_AppMissed extends AppiumSetup implements Constants{
...
//		WCCheck.GreatNews_FirstName(CustDet.split(",")[1]);
		WCCheck.MissedAppointment();	

		WCCheck.ToggleButton();
		MyOrders.ModuleName("Fastest Ultra Fibre Optic","");
		MyOrders.PackageName("Fastest Ultra Fibre Optic","");	
		MyOrders.FullPackDetailsButon();
		MyOrders.FullPackDetails("Fastest Ultra Fibre Optic","");
