...
public class TC27_AIP_NL_293_TV_PVR_Cancelled extends AppiumSetup implements Constants{
...
//		Welcome.GreatNews_FirstName(CustDet.split(",")[1]);
		WCCheck.Cancelled_Text("Fastest Ultra Fibre Optic", "Plus");
