...
public class TC12_AIP_NL_292_FA_TVNOBOX_Complete extends AppiumSetup implements Constants{
	...
	public void TC01SBBNewlinePostCodeOnly() throws Exception {
		...
		/************************** Objects Declaration **********************************/
		String CLI="", Password="password1",CustDet=null,PackName="Fast Broadband",TVBOX="";
		...
		WCCheck.GreatNews_CompleteOrder(TVBOX,"Faster Fibre");
