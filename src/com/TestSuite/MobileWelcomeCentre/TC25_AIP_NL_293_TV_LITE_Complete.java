...
public class TC25_AIP_NL_293_TV_LITE_Complete extends AppiumSetup implements Constants{
	...
	public void TC01SBBNewlinePostCodeOnly() throws Exception {
		...
		WCCheck.GreatNews_CompleteOrder("Fastest Ultra Fibre Optic","LITE");
		
		WCCheck.ToggleButton();
		MyOrders.ModuleName("Fastest Ultra Fibre Optic","LITE");
		MyOrders.PackageName("Fastest Ultra Fibre Optic","LITE");	
		MyOrders.FullPackDetailsButon();
		MyOrders.FullPackDetails("Fastest Ultra Fibre Optic","LITE");
