...
public class TC01_AIP_NL_291_TVStore extends AppiumSetup implements Constants{
	...
	public void TC01_AIP_NL_291_TVStore() throws Exception {
		
		/************************** Objects Declaration **********************************/
		String CLI="", Password="password1",CustDet=null;
		...
		WCCheck.CheckFirstName(CustDet.split(",")[0]);
