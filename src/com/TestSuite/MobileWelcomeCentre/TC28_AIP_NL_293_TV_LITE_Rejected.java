...
public class TC28_AIP_NL_293_TV_LITE_Rejected extends AppiumSetup implements Constants{
	...
	public void TC01SBBNewlinePostCodeOnly() throws Exception {
		...
		WCCheck.Rejected_Text("Fastest Ultra Fibre Optic", "Plus",CustDet.split(",")[1]);
