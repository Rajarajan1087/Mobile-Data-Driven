...
public class TC39_AIP_IS_292_TVNOBOX_AllServices_Complete extends AppiumSetup implements Constants{
	...
	public void TC01SBBNewlinePostCodeOnly() throws Exception {
		...
		WCCheck.GreatNews_CompleteOrder("TV","Faster Fibre");
		/*
		...
		else
		{
			...
			WCCheck.GreatNews_CompleteOrder("NOBOX","Faster Fibre");
